...
def create_transaction_item(data: CreateTransactionItemData, user_id: int = Header(0, alias='X-Consumer-ID')):
  if user_id == 0:
  ...
  with Session(db_engine) as session:
    ...
    if not product:
      raise HTTPException(400, detail='Produk tidak ditemukan')
